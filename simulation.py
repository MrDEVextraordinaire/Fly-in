    ...
    def run(self) -> None:
        ...
        while not all(drone.has_arrived for drone in drones):
            ...
            for drone in active_drones:
                ...
                # find the connection between the current_zone and next_zone
                conn = next(
                    c
                ...
                if (
                    ...
                    color_code = self.visualizer.COLORS.get(current_zone.color, "")
                    turn_moves.append(
                        f"D{drone.drone_id}-{color_code}{current_zone.name}{self.visualizer.RESET}"
                    )
